package com.bustracking.services;
...
public class LocationService extends Service {
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            Log.e(TAG, "getLocation: stopping the location service// PERMISSION NOT SET");
            stopSelf();
            return;
        }
        ...
        mFusedLocationClient.requestLocationUpdates(mLocationRequestHighAccuracy, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (location != null) {
                            ...
                            if(hasSaved)
                            {
                                saveUserLocation(userLocation, new firebaseCallback() {
                                    @Override
    ...
    private void saveUserLocation(final UserLocation userLocation, firebaseCallback fC){
        ...
        try{
            ...
            Log.d(TAG, "LocationService saving location service to firebase");
